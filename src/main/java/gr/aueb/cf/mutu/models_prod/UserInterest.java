...
public class UserInterest {
    ...
    static {
        ...
        userInterests.add(new UserInterest(9, 2, 2));
        userInterests.add(new UserInterest(10, 2, 3));
        userInterests.add(new UserInterest(11, 2, 4));
        userInterests.add(new UserInterest(12, 2, 5));
